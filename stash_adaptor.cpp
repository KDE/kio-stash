...
dirListDBus::dirList StashNotifierAdaptor::fileList(const QString &path)
{
    // handle method call org.kde.kio.StashNotifier.fileList
    dirListDBus::dirList contents;
    QMetaObject::invokeMethod(parent(), "fileList", Q_RETURN_ARG(dirListDBus::dirList, contents), Q_ARG(QString, path));
    return contents;
}
